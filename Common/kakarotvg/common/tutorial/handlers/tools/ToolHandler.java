package kakarotvg.common.tutorial.handlers.tools;
...
public class ToolHandler {
    ...
    public static void configureTools(Configuration config) {
        tutorialaxe = new TutorialAxe(ToolIDs.tutorialaxeID, TUTORIALTOOLS).setUnlocalizedName("tutorialaxe").setCreativeTab(CreativeTabHandler.ttab);
        tutorialhoe = new TutorialHoe(ToolIDs.tutorialhoeID, TUTORIALTOOLS).setUnlocalizedName("tutorialhoe").setCreativeTab(CreativeTabHandler.ttab);
        tutorialshovel = new TutorialShovel(ToolIDs.tutorialshovelID, TUTORIALTOOLS).setUnlocalizedName("tutorialshovel").setCreativeTab(CreativeTabHandler.ttab);
        tutorialsword = new TutorialSword(ToolIDs.tutorialswordID, TUTORIALTOOLS).setUnlocalizedName("tutorialsword").setCreativeTab(CreativeTabHandler.ttab);
        tutorialpickaxe = new TutorialPickaxe(ToolIDs.tutorialpickaxeID, TUTORIALTOOLS).setUnlocalizedName("tutorialpickaxe").setCreativeTab(CreativeTabHandler.ttab);
    }

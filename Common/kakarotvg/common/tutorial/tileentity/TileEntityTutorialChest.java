package kakarotvg.common.tutorial.tileentity;
...
public class TileEntityTutorialChest extends TileEntity implements IInventory {
    ...
    public TileEntityTutorialChest adjacentChestZNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTutorialChest adjacentChestXPos;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTutorialChest adjacentChestXNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTutorialChest adjacentChestZPosition;
    ...
    public TileEntityTutorialChest() {
        this.field_94046_i = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityTutorialChest(int par1) {
    ...
    private void func_90009_a(TileEntityTutorialChest par1TileEntityChest, int par2) {
    ...
    public void checkForAdjacentChests() {
        if (!this.adjacentChestChecked) {
            ...
            if (this.func_94044_a(this.xCoord - 1, this.yCoord, this.zCoord)) {
                this.adjacentChestXNeg = (TileEntityTutorialChest) this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord)) {
                this.adjacentChestXPos = (TileEntityTutorialChest) this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1)) {
                this.adjacentChestZNeg = (TileEntityTutorialChest) this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1)) {
                this.adjacentChestZPosition = (TileEntityTutorialChest) this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_94044_a(int par1, int par2, int par3) {
        ...
        return block != null && block instanceof TutorialChest ? ((TutorialChest) block).isTrapped == this.func_98041_l() : false;
    }
    ...
    public void closeChest() {
        if (this.getBlockType() != null && this.getBlockType() instanceof TutorialChest) {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord - 1, this.zCoord, this.getBlockType().blockID);
    ...
    public int func_98041_l() {
        if (this.field_94046_i == -1) {
            if (this.worldObj == null || !(this.getBlockType() instanceof TutorialChest)) {
                return 0;
            }

            this.field_94046_i = ((TutorialChest) this.getBlockType()).isTrapped;
        }

...
public class TutorialChest extends BlockContainer {
    private final Random random = new Random();

    /** Determines whether of not the chest is trapped. */
    public final int isTrapped;

    public TutorialChest(int par1, int par2) {
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack) {
        ...
        if (par6ItemStack.hasDisplayName()) {
            ((TileEntityTutorialChest) par1World.getBlockTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5) {
        ...
        TileEntityTutorialChest tileentitychest = (TileEntityTutorialChest) par1World.getBlockTileEntity(par2, par3, par4);
    ...
    public IInventory getInventory(World par1World, int par2, int par3, int par4) {
        Object object = (TileEntityTutorialChest) par1World.getBlockTileEntity(par2, par3, par4);
        ...
        if (object == null) {
            ...
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID) {
                object = new InventoryLargeChest("Tutorial Chest", (TileEntityTutorialChest) par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory) object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID) {
                object = new InventoryLargeChest("Tutorial Chest", (IInventory) object, (TileEntityTutorialChest) par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID) {
                object = new InventoryLargeChest("Tutorial Chest", (TileEntityTutorialChest) par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory) object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID) {
                object = new InventoryLargeChest("Tutorial Chest", (IInventory) object, (TileEntityTutorialChest) par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    public TileEntity createNewTileEntity(World par1World) {
        TileEntityTutorialChest tileentitychest = new TileEntityTutorialChest();
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5) {
        if (!this.canProvidePower()) {
            ...
            int i1 = ((TileEntityTutorialChest) par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
